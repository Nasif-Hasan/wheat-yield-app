...
<style>
    ...
    .metric-card h2 { color: #a5d6a7; font-size: 2rem; margin: 0; }
    .metric-card p  { color: #81c784; font-size: 0.85rem; margin: 0; }
...
st.markdown('<div class="hero-sub">Machine Learning model trained on real farm data to predict wheat yield (kg/ha)</div>', unsafe_allow_html=True)
...
with tab3:
    ...
    st.caption("Adjust the sliders below to match your farm's conditions and get a yield prediction.")
